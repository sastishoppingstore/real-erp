...
// ── AUTO-GENERATED: minimal relations for tables used via db.query (QA fix) ──
export const aiAutomationRulesRelations = relations(schema.aiAutomationRules, () => ({}));
export const aiAutomationSuggestionsRelations = relations(schema.aiAutomationSuggestions, () => ({}));
export const aiChatbotSessionsRelations = relations(schema.aiChatbotSessions, () => ({}));
export const aiReportTemplatesRelations = relations(schema.aiReportTemplates, () => ({}));
export const biDataWarehouseTablesRelations = relations(schema.biDataWarehouseTables, () => ({}));
export const biometricConsentRecordsRelations = relations(schema.biometricConsentRecords, () => ({}));
export const branchesRelations = relations(schema.branches, () => ({}));
export const cashboxTransactionsRelations = relations(schema.cashboxTransactions, () => ({}));
export const companiesRelations = relations(schema.companies, () => ({}));
export const companyLegalDetailsRelations = relations(schema.companyLegalDetails, () => ({}));
export const consolidationGroupsRelations = relations(schema.consolidationGroups, () => ({}));
export const contractCostsRelations = relations(schema.contractCosts, () => ({}));
export const couponsRelations = relations(schema.coupons, () => ({}));
export const dashboardWidgetsRelations = relations(schema.dashboardWidgets, () => ({}));
export const dashboardsRelations = relations(schema.dashboards, () => ({}));
export const desktopLicensesRelations = relations(schema.desktopLicenses, () => ({}));
export const deviceRegistrationsRelations = relations(schema.deviceRegistrations, () => ({}));
export const emailTemplatesRelations = relations(schema.emailTemplates, () => ({}));
export const gosiRegistrationsRelations = relations(schema.gosiRegistrations, () => ({}));
export const impersonationLogsRelations = relations(schema.impersonationLogs, () => ({}));
export const installmentPaymentsRelations = relations(schema.installmentPayments, () => ({}));
export const installmentsRelations = relations(schema.installments, () => ({}));
export const intercompanyTransactionsRelations = relations(schema.intercompanyTransactions, () => ({}));
export const iqamaRecordsRelations = relations(schema.iqamaRecords, () => ({}));
export const leaseContractsRelations = relations(schema.leaseContracts, () => ({}));
export const leasePaymentSchedulesRelations = relations(schema.leasePaymentSchedules, () => ({}));
export const meetingsRelations = relations(schema.meetings, () => ({}));
export const mrpPlannedOrdersRelations = relations(schema.mrpPlannedOrders, () => ({}));
export const mrpRunsRelations = relations(schema.mrpRuns, () => ({}));
export const notificationTemplatesRelations = relations(schema.notificationTemplates, () => ({}));
export const patientsRelations = relations(schema.patients, () => ({}));
export const performanceObligationsRelations = relations(schema.performanceObligations, () => ({}));
export const plansRelations = relations(schema.plans, () => ({}));
export const posHoldsRelations = relations(schema.posHolds, () => ({}));
export const posSessionsRelations = relations(schema.posSessions, () => ({}));
export const qiwaContractsRelations = relations(schema.qiwaContracts, () => ({}));
export const reportSchedulesRelations = relations(schema.reportSchedules, () => ({}));
export const reportTemplatesRelations = relations(schema.reportTemplates, () => ({}));
export const revenueRecognitionSchedulesRelations = relations(schema.revenueRecognitionSchedules, () => ({}));
export const rfqHeadersRelations = relations(schema.rfqHeaders, () => ({}));
export const smtpSettingsRelations = relations(schema.smtpSettings, () => ({}));
export const storageLocationsRelations = relations(schema.storageLocations, () => ({}));
export const subscriptionPlansRelations = relations(schema.subscriptionPlans, () => ({}));
export const subscriptionsRelations = relations(schema.subscriptions, () => ({}));
export const syncStatsRelations = relations(schema.syncStats, () => ({}));
export const taxCredentialsRelations = relations(schema.taxCredentials, () => ({}));
export const taxIntegrationsRelations = relations(schema.taxIntegrations, () => ({}));
export const tenantLimitsOverrideRelations = relations(schema.tenantLimitsOverride, () => ({}));
export const tenantModulesRelations = relations(schema.tenantModules, () => ({}));
export const tenantUsageRelations = relations(schema.tenantUsage, () => ({}));
export const workflowApprovalsRelations = relations(schema.workflowApprovals, () => ({}));
export const workflowLogsRelations = relations(schema.workflowLogs, () => ({}));
export const workflowStepsRelations = relations(schema.workflowSteps, ({ one }) => ({
  workflow: one(schema.workflows, { fields: [schema.workflowSteps.workflowId], references: [schema.workflows.id] }),
}));
export const workflowsRelations = relations(schema.workflows, ({ many }) => ({
  steps: many(schema.workflowSteps),
  approvals: many(schema.workflowApprovals),
  logs: many(schema.workflowLogs),
}));
export const wpsSubmissionsRelations = relations(schema.wpsSubmissions, () => ({}));
export const zatcaApiLogsRelations = relations(schema.zatcaApiLogs, () => ({}));
export const zatcaCertificatesRelations = relations(schema.zatcaCertificates, () => ({}));
export const zatcaCredentialsRelations = relations(schema.zatcaCredentials, () => ({}));
export const zatcaInvoiceStatusRelations = relations(schema.zatcaInvoiceStatus, () => ({}));
export const zatcaQrCodesRelations = relations(schema.zatcaQrCodes, () => ({}));
export const zatcaXmlDocumentsRelations = relations(schema.zatcaXmlDocuments, () => ({}));
export const documentVersionsRelations = relations(schema.documentVersions, () => ({}));
export const documentExpiryRemindersRelations = relations(schema.documentExpiryReminders, () => ({}));
