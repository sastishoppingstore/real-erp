...
export const BUSINESS_CATALOG: BusinessCatalogItem[] = [
  ...
  },
  {
    ...
    description: "Agencies for video, ads, social, SEO, brand design, influencers and PR.",
    descriptionAr: "وكالات فيديو، إعلانات، سوشيال، SEO، هوية، مؤثرين وعلاقات عامة.",
    subCategories: ["Video Content Creation and Commercial Ads", "Social Media Management", "SEO and Search Engine Marketing", "Brand Identity and Graphic Design", "Influencer Marketing Agencies", "Digital PR and Corporate Communications"],
